...
public class FinLogController {
    ...
    ResponseEntity<List<UserAccountFinancialLogRecordDto>> getUserFinancialLog(Authentication authentication, @RequestParam(defaultValue = "", required = false) UUID orderId) {
