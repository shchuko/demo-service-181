package com.itmo.microservices.shop.demo.tasks.impl.service
...
import com.itmo.microservices.shop.demo.tasks.api.messaging.TaskAssignedEvent
import com.itmo.microservices.shop.demo.tasks.api.messaging.TaskCreatedEvent
import com.itmo.microservices.shop.demo.tasks.api.messaging.TaskDeletedEvent
import com.itmo.microservices.shop.demo.tasks.api.model.TaskModel
import com.itmo.microservices.shop.demo.tasks.api.service.TaskService
import com.itmo.microservices.shop.demo.tasks.impl.logging.TaskServiceNotableEvents
import com.itmo.microservices.shop.demo.tasks.impl.util.toEntity
import com.itmo.microservices.shop.demo.tasks.impl.util.toModel
import com.itmo.microservices.shop.demo.tasks.impl.repository.TaskRepository
